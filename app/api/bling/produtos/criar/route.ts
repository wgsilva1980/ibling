...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Criar como produto simples no Bling
    // Nota: Variações são vinculadas automaticamente pelo padrão de nome
    // Exemplo: "Camiseta COR:Azul;TAM:G" agrupa com outras "Camiseta COR:*;TAM:*"
    const corpo: any = {
      codigo,
      nome,
    ...
    console.log(`Criando produto no Bling:`, JSON.stringify(corpo, null, 2));
